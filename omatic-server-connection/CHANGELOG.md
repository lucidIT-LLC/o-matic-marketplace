...
- Documented Conductor, from O-Matic, as the follow-on runtime bridge for
  simplifying local, LAN, tailnet, and remote-host usage without turning every
  marketplace plugin into a network daemon.
